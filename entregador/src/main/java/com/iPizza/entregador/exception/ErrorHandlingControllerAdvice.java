...
public class ErrorHandlingControllerAdvice {
    ...
    @ResponseBody
    public CustomErrorType onNotFoundException(NotFoundException notFoundException) {
        return defaultCustomErrorTypeConstruct(
    ...
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    @ResponseBody
    public CustomErrorType onInvalidCodeException(InvalidCodeException invalidCodeException) {
        return defaultCustomErrorTypeConstruct(
                invalidCodeException.getMessage()
        );
    }
